...
class BannerWigetPage extends StatefulWidget {
  const BannerWigetPage({Key? key}) : super(key: key);

  @override
  State<BannerWigetPage> createState() => _BannerWigetPageState();
}

class _BannerWigetPageState extends State<BannerWigetPage> {
