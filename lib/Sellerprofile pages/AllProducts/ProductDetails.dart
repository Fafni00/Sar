  ...
  void initState() {
    setState(() {
      ...
      _regularPrice.text = widget.product?.regularPrice != null
          ...
          : ' ';
      _salesPrice.text = widget.product?.salesPrice != null
      ...
      _additionalDetail.text = widget.product?.additionalDetail != null
          ...
          : ' ';
      if (widget.product!.saledate != null) {
        saledate = DateTime.fromMicrosecondsSinceEpoch(
            widget.product!.saledate!.microsecondsSinceEpoch);
      }
